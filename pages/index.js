...
export default function Home() {
  ...
  return (
    <div className='flex flex-col items-center justify-center'>
      ...
      <h1 className='font-sans text-5xl justify-center font-bold pt-5 text-[#ffecfc]'>Code Translator</h1>
      <h2 className="font-sans mt-5 text-xl justify-center text-slate-600 mb-10 text-[#ffecfc]">Translate your code to another programming language. With just a click.</h2>
      ...
      <p className="font-sans mt-5 pb-5 text-[#ffecfc]">Created by <a className="ref-link text-[#C53AAE]" href="https://www.linkedin.com/in/anshu-kumar-57ab7924a/" target="_blank" rel="noopener noreferrer">Anshu Kumar</a></p>
    </div>
